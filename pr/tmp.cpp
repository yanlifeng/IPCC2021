...
#pragma omp parallel for num_threads(threadNumber)
    ...
    cout << "minCost0 : " << minCost0 <<
         endl;
    cout << "minCost1 : " << minCost1 <<
         endl;
    cout << "minCost2 : " << minCost2 <<
         endl;
    cout << "minCost3 : " << minCost3 <<
         endl;
    cout << "minCost4 : " << minCost4 <<
         endl;
    cout << "minCost5 : " << minCost5 <<
         endl;
    cout << "minCost6 : " << minCost6 <<
         endl;
#endif
}
